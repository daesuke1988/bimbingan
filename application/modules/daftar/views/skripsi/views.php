...
<div class="col-lg-12">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <?php
            if (!empty($cek)) {
                if ((strtotime($cek['tgl_akhir']) > strtotime(date("d-m-Y"))) || (($cek['semester'] !== $config['semester']) || ($cek['tahun'] == $config['tahun'])) || (is_null($cek['approv_kaprodi']))) {
                    echo  '';
                } else {
                    echo '<a class="btn btn-success" href="' . base_url() . 'daftar/skripsi/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Skripsi</a>';
                }
            } else {
                echo '<a class="btn btn-success" href="' . base_url() . 'daftar/skripsi/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Skripsi</a>';
            }
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <div class="tooltip-demo">
                                    <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Edit" href="<?= base_url() ?>daftar/skripsi/update/<?= urlencode(base64_encode($row->id)); ?>">
...
<script>
    ...
    function showDetail(id) {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('daftar/skripsi/detail'); ?>',
            cache: false,
            data: {
                id: id
            },
