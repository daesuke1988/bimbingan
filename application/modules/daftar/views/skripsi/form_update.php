            ...
            <div class="col-lg-7">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <form method="post" action="<?php echo base_url(); ?>daftar/skripsi/update/<?php echo urlencode(base64_encode($pengajuan['id_skripsi'])); ?>" enctype="multipart/form-data">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="judul" placeholder="Masukan Rencana Judul Skripsi" value="<?php echo $pengajuan['judul']; ?>">
                                <span class="form-text m-b-none">
                                    <font color="red">wajib diisi.*</font>
                                </span>
