                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <div class="tooltip-demo">
                                    <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Persetujuan" href="<?= base_url() ?>daftar/skripsi/persetujuan/<?= urlencode(base64_encode($row->id)); ?>">
