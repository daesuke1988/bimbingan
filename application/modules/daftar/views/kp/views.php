        ...
        <div class="panel-body">
            ...
            if (!empty($cek)) {
                if ((strtotime($cek['tgl_akhir']) > strtotime(date("d-m-Y")))) {
                    ...
                    echo '<a class="btn btn-success" href="' . base_url() . 'daftar/kerjapraktek/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Kerja Praktek</a>';
                }
            } else {
                echo '<a class="btn btn-success" href="' . base_url() . 'daftar/kerjapraktek/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Kerja Praktek</a>';
            }
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <div class="tooltip-demo">
                                    <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Edit" href="<?= base_url() ?>daftar/kerjapraktek/update/<?= urlencode(base64_encode($row->id)); ?>">
