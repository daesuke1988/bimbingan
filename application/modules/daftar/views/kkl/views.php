...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
            :: Data Kuliah Kerja Praktek
        </div>
        <div class="panel-body">
            <?php
            if (!empty($cek)) {
                if ((strtotime($cek['tgl_akhir']) > strtotime(date("d-m-Y")))) {
                    echo  '';
                } elseif ($cek['semester'] == $config['semester']) {
                    echo '';
                } else {
                    echo '<a class="btn btn-success" href="' . base_url() . 'daftar/kkl/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Kuliah Kerja Praktek</a>';
                }
            } else {
                echo '<a class="btn btn-success" href="' . base_url() . 'daftar/kkl/insert"> <i class="fa fa-plus-square"></i> Pendaftaran Kuliah Kerja Praktek</a>';
            }
                        ...
                        <tr>
                            ...
                            <td width="15%">
                                <div class="tooltip-demo">
                                    <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Edit" href="<?= base_url() ?>daftar/kkl/update/<?= urlencode(base64_encode($row->id)); ?>">
