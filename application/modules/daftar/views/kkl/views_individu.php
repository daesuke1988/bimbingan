...
<div class="col-lg-12">
    <div class="panel panel-primary">
        <div class="panel-heading">
            :: Data Pendaftaran Kuliah Kerja Lapangan Individu
        </div>
                        ...
                        <tr>
                            ...
                            <td width="10%">
                                <div class="tooltip-demo">
                                    <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Persetujuan" href="<?= base_url() ?>daftar/kkl/persetujuan/<?= urlencode(base64_encode($row->id)); ?>">
                                        <i class="fa fa-handshake-o"></i>
                                    </a>
                                    <a class="btn btn-outline btn-success" onclick="showDetail(<?php echo $row->id; ?>);" data-target="#myModal" data-toggle="tooltip" data-original-title="Detail File"><i class="fa fa-download"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php
