...
<body>
    ...
    <center>
        <strong>
            ...
            TENTANG : <br />PEMBIMBINGAN SKRIPSI<strong>
    </center>
    <table class="table1">
        <tr>
    ...
    <table class="table1">
        <tr>
            ...
            <td align="justify" colspan="2">
                Surat tugas sebagai pembimbing Skripsi kepada <strong><?php echo $skripsi['dosen'] ?></strong> yang ditunjuk untuk mahasiswa Informatika sebagaimana terlampir.
