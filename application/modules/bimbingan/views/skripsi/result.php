...
<div class="form-group row">
    <div class="col-sm-12">
        <a class="btn btn-warning pull-right" data-placement="top" data-toggle="tooltip" data-original-title="Cetak SK" target="_blank" href="<?= base_url() ?>bimbingan/skripsi/cetak_sk/<?php echo urlencode(base64_encode(@$tahun)); ?>/<?php echo urlencode(base64_encode(@$semester)); ?>">
    ...
    ?> <tr>
            ...
            <td width="16%">
                <div class="tooltip-demo">
                    ...
                    ?>
                        <a class="btn btn btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Bimbingan" href="<?= base_url() ?>bimbingan/skripsi/bimbingan/<?= urlencode(base64_encode($row->id_skripsi)); ?>">
                            <i class="fa fa-print"></i>
                        </a>
                    <?php
                    } else {
                    ?>
                        <a class="btn btn-outline btn-info" data-placement="top" data-toggle="tooltip" data-original-title="Bimbingan" href="<?= base_url() ?>bimbingan/skripsi/bimbingan/<?= urlencode(base64_encode($row->id_skripsi)); ?>">
                        ...
                        if ($role == '2') {
                        ?>
                            <a class="btn btn-outline btn-danger" data-placement="top" data-toggle="tooltip" data-original-title="Tidak Setuju" href="<?= base_url() ?>bimbingan/skripsi/unapprov/<?= urlencode(base64_encode($row->id_skripsi)); ?>">
