                                ...
                                <div class="tooltip-demo">
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding:3px;"><a class="btn btn-outline btn-success" onclick="showDetail(<?php echo $row->id_skripsi; ?>);" data-target="#myModal" data-toggle="tooltip" data-original-title="Detail File"><i class="fa fa-file-text"></i></a></td>
                                            <?php
                                            if ($row->approv_kaprodi == 't') {
                                            ?>
                                                <td style="padding:3px;">
                                            ...
                                            ?>
                                                <td style="padding:3px;">
                                                    <form action="<?php echo base_url(); ?>bimbingan/skripsi/lanjut" method="post">
