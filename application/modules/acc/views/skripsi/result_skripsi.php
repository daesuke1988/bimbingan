    ...
    ?> <tr>
            ...
            <td>
                <div class="tooltip-demo">
                    <a class="btn btn-success" data-placement="top" data-toggle="tooltip" data-original-title="Cetak Riwayat Bimbingan" href="<?php echo base_url(); ?>bimbingan/skripsi/cetak_pdf/<?php echo urlencode(base64_encode($row->id_skripsi)); ?>" target="_blank">
