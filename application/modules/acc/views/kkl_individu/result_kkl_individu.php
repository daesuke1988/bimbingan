    ...
    ?> <tr>
            ...
            <td>
                <div class="tooltip-demo">
                    <a class="btn btn-success" data-placement="top" data-toggle="tooltip" data-original-title="Cetak Riwayat Bimbingan" href="<?php echo base_url(); ?>bimbingan/kkl/cetak_pdf_bimbingan_individu/<?php echo urlencode(base64_encode($row->id_kkl)); ?>" target="_blank">
