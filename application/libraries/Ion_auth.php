...
class Ion_auth {
    ...
    public function is_allow($function, $redirect = NULL) {
        $this->ion_auth_model->trigger_events('is_allow');
//        if (!$this->logged_in()) {
//            if ($redirect == NULL) {
//                redirect('/user/?redirect=' . current_url(), 'refresh');
//            } else {
//                redirect($redirect, 'refresh');
//            }
//        }
//
        if (!$this->privilege($function)) {
            if ($redirect = NULL) {
    ...
    public function is_mahasiswa($id = false) {
        ...
        return $this->in_group('mahasiswa', $id);
    }

    public function is_rektorat($id = false) {
        $this->ion_auth_model->trigger_events('is_rektorat');
        return $this->in_group('admin_rektorat', $id);
    }
