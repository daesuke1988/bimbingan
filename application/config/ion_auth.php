...
$config['tables']['functions']		= 'functions';
...
$config['join']['functions'] 	= 'function_id';
...
$config['user_email']				  = 'email';			 // A database column for user email login
$config['identity']                   = 'email';             // A database column which is used to login with
$config['username']					  = 'username';			 // A database column for username login
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['message_start_delimiter'] = '<div class="alert alert-error">
										<button class="close" data-dismiss="alert"></button>
										<span>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</span>
      								</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-error">
										<button class="close" data-dismiss="alert"></button>
										<span>';		// Error mesage start delimiter
$config['error_end_delimiter']     = '</span>
      								</div>';	// Error mesage end delimiter
